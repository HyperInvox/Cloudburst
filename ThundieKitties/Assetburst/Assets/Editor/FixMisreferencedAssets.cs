...
namespace ThunderKit.Migration
{
    ...
    {
        public const ulong idConstant = 11500000;

        [MenuItem("ThunderKit/Selection/Switch DLL references to CS references")]
        public static void Execute()
        {
            try
            {
                ...
                var monoScripts = AssetDatabase.FindAssets("t:MonoScript").Select(AssetDatabase.GUIDToAssetPath).Select(AssetDatabase.LoadAssetAtPath<MonoScript>).ToArray();
