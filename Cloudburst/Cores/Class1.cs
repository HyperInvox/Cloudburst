...
namespace Cloudburst.Cores
{
    class Lui : SurvivorCreator<Lui>
    {
        ...
        public override GameObject survivorDisplay => AssetsCore.mainAssetBundle.LoadAsset<GameObject>("mdlBombardierReal");//("mdLui");

        public override GameObject survivorMdl => AssetsCore.mainAssetBundle.LoadAsset<GameObject>("mdlBombardierReal");//("mdLui");
