...
{
    class Bruiser : EnemyCreator<Bruiser>
    {
        ...
        public override string EnemyInternalName => "TarGurdian";

        public override string BodyName => "TarGuardian";


        public override GameObject EnemyMdl => AssetsCore.mainAssetBundle.LoadAsset<GameObject>("mdlClayGuardsman");
        ...
        {
            base.CreateMaster();
            GameObject gameObject = Resources.Load<GameObject>("Prefabs/CharacterMasters/LemurianMaster").InstantiateClone(EnemyInternalName + "Master", true);
...
localScale = new Vector3(0.015F, 0.015F, 0.015F),
        ...
        public override void SetupCharacterBody(CharacterBody characterBody)
        {
            ...
            characterBody.preferredPodPrefab = Resources.Load<GameObject>("prefabs/networkedobjects/EnemyPod");
        }

        public override void CreatePrimary(SkillLocator skillLocator, SkillFamily skillFamily)
        {
            Cloudburst.Content.ContentHandler.Loadouts.RegisterEntityState(typeof(Cores.States.Bruiser.Swing));
            ...
            primarySkillDef.activationState = new EntityStates.SerializableEntityStateType(typeof(Cores.States.Bruiser.Swing));
        ...
        public override void CreateSecondary(SkillLocator skillLocator, SkillFamily skillFamily)
        {
            ...
            Cloudburst.Content.ContentHandler.Loadouts.RegisterEntityState(typeof(States.Bruiser.Stomp));
            ...
            secondarySkillDef.activationState = new EntityStates.SerializableEntityStateType(typeof(States.Bruiser.Stomp));
